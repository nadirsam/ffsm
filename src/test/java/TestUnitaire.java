...
public class TestUnitaire {
    ...
    public void setUp() {
        ...
        moniteur = new Moniteur("5896", "Lacroix", "Belle", "Castres", "006845221", Calendar.getInstance(), 4);
        club = new Club(moniteur, "clubJava", "58875");
        ...
        plongeur = new Plongeur("47", "Poireaux", "Rene", "Villeneuve", "257961235", Calendar.getInstance(), 6, 5);
        plongeur2 = new Plongeur("33", "Chouchou", "Pierre", "Pessac", "25698756", Calendar.getInstance(), 7, 8);
